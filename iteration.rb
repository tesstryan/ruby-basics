...
# # Hard Challenge: Based on the data stored in the shopping_cart,
# #sales_tax, and params variables below, write code that prints out
# #the customer's total, including estimated sales tax, based on the shipping
# #address they entered. Your code should work even if the values of the data change.
